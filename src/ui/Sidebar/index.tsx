...
const Sidebar: FC = () => {
	...
	const accountLinks = <>
		...
		{user && <li><Link to="/logout"><Icon kind="backward" /><span className="label">Logout</span></Link></li>}
		{!user && <li><Link to="/login"><Icon kind="forward" /><span className="label">Login</span></Link></li>}
		{!user && <li><Link to="/register"><Icon kind="group" /><span className="label">Register</span></Link></li>}
	</>;
